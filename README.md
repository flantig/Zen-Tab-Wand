...
- **AI title learning** — Ollama-only. When set to Review and Save, reviewed title chips from tab titles can be added to existing or new title-only rules during modal-confirmed rule growth.
