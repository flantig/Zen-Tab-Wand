...
4. **alignSettingRows** — tags native preference rows so controls share a fixed start column; checkbox controls are moved out of label text when Sine nests them.
